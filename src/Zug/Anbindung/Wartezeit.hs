...
warte (NanoSekunden ns) =
    let µs = div ns nsInµs
    in liftIO $ when (µs > 0) $ threadDelay $ fromIntegral µs
...
instance Ord Wartezeit where
    ...
    compare (NanoSekunden ns1) (NanoSekunden ns2) = compare ns1 ns2
    compare (NanoSekunden ns) (MikroSekunden µs) = compare ns $ nsInµs * µs
    compare (NanoSekunden ns) (MilliSekunden ms) = compare ns $ nsInms * ms
    compare (NanoSekunden ns) (Sekunden s) = compare ns $ nsInS * s
    compare (NanoSekunden ns) (Minuten min) = compare ns $ nsInMin * min
    compare (NanoSekunden ns) (Stunden h) = compare ns $ nsInH * h
    compare (NanoSekunden ns) (Tage d) = compare ns $ nsInD * d
    compare (MikroSekunden µs) (NanoSekunden ns) = compare (nsInµs * µs) ns
    compare (MikroSekunden µs1) (MikroSekunden µs2) = compare µs1 µs2
    compare (MikroSekunden µs) (MilliSekunden ms) = compare µs $ µsInms * ms
    compare (MikroSekunden µs) (Sekunden s) = compare µs $ µsInS * s
    compare (MikroSekunden µs) (Minuten min) = compare µs $ µsInMin * min
    compare (MikroSekunden µs) (Stunden h) = compare µs $ µsInH * h
    compare (MikroSekunden µs) (Tage d) = compare µs $ µsInD * d
    compare (MilliSekunden ms) (NanoSekunden ns) = compare (nsInms * ms) ns
    compare (MilliSekunden ms) (MikroSekunden µs) = compare (µsInms * ms) µs
    compare (MilliSekunden ms1) (MilliSekunden ms2) = compare ms1 ms2
    compare (MilliSekunden ms) (Sekunden s) = compare ms $ msInS * s
    compare (MilliSekunden ms) (Minuten min) = compare ms $ msInMin * min
    compare (MilliSekunden ms) (Stunden h) = compare ms $ msInH * h
    compare (MilliSekunden ms) (Tage d) = compare ms $ msInD * d
    compare (Sekunden s) (NanoSekunden ns) = compare (nsInS * s) ns
    compare (Sekunden s) (MikroSekunden µs) = compare (µsInS * s) µs
    compare (Sekunden s) (MilliSekunden ms) = compare (msInS * s) ms
    compare (Sekunden s1) (Sekunden s2) = compare s1 s2
    compare (Sekunden s) (Minuten min) = compare s $ sInMin * min
    compare (Sekunden s) (Stunden h) = compare s $ sInH * h
    compare (Sekunden s) (Tage d) = compare s $ sInD * d
    compare (Minuten min) (NanoSekunden ns) = compare (nsInMin * min) ns
    compare (Minuten min) (MikroSekunden µs) = compare (µsInMin * min) µs
    compare (Minuten min) (MilliSekunden ms) = compare (msInMin * min) ms
    compare (Minuten min) (Sekunden s) = compare (sInMin * min) s
    compare (Minuten min1) (Minuten min2) = compare min1 min2
    compare (Minuten min) (Stunden h) = compare min $ minInH * h
    compare (Minuten min) (Tage d) = compare min $ minInD * d
    compare (Stunden h) (NanoSekunden ns) = compare (nsInH * h) ns
    compare (Stunden h) (MikroSekunden µs) = compare (µsInH * h) µs
    compare (Stunden h) (MilliSekunden ms) = compare (msInH * h) ms
    compare (Stunden h) (Sekunden s) = compare (sInH * h) s
    compare (Stunden h) (Minuten min) = compare (minInH * h) min
    compare (Stunden h1) (Stunden h2) = compare h1 h2
    compare (Stunden h) (Tage d) = compare h $ hInD * d
    compare (Tage d) (NanoSekunden ns) = compare (nsInD * d) ns
    compare (Tage d) (MikroSekunden µs) = compare (µsInD * d) µs
    compare (Tage d) (MilliSekunden ms) = compare (msInD * d) ms
    compare (Tage d) (Sekunden s) = compare (sInD * d) s
    compare (Tage d) (Minuten min) = compare (minInD * d) min
    compare (Tage d) (Stunden h) = compare (hInD * d) h
    compare (Tage d1) (Tage d2) = compare d1 d2
...
instance Semigroup Wartezeit where
    ...
    (<>) (NanoSekunden ns) (MikroSekunden µs) = NanoSekunden $ (+) ns $ nsInµs * µs
    (<>) (NanoSekunden ns) (MilliSekunden ms) = NanoSekunden $ (+) ns $ nsInms * ms
    (<>) (NanoSekunden ns) (Sekunden s) = NanoSekunden $ (+) ns $ nsInS * s
    (<>) (NanoSekunden ns) (Minuten min) = NanoSekunden $ (+) ns $ nsInMin * min
    (<>) (NanoSekunden ns) (Stunden h) = NanoSekunden $ (+) ns $ nsInH * h
    (<>) (NanoSekunden ns) (Tage d) = NanoSekunden $ (+) ns $ nsInD * d
    (<>) (MikroSekunden µs) (NanoSekunden ns) = MikroSekunden $ (+) (nsInµs * µs) ns
    (<>) (MikroSekunden µs1) (MikroSekunden µs2) = MikroSekunden $ (+) µs1 µs2
    (<>) (MikroSekunden µs) (MilliSekunden ms) = MikroSekunden $ (+) µs $ µsInms * ms
    (<>) (MikroSekunden µs) (Sekunden s) = MikroSekunden $ (+) µs $ µsInS * s
    (<>) (MikroSekunden µs) (Minuten min) = MikroSekunden $ (+) µs $ µsInMin * min
    (<>) (MikroSekunden µs) (Stunden h) = MikroSekunden $ (+) µs $ µsInH * h
    (<>) (MikroSekunden µs) (Tage d) = MikroSekunden $ (+) µs $ µsInD * d
    (<>) (MilliSekunden ms) (NanoSekunden ns) = NanoSekunden $ (+) (nsInms * ms) ns
    (<>) (MilliSekunden ms) (MikroSekunden µs) = MikroSekunden $ (+) (µsInms * ms) µs
    (<>) (MilliSekunden ms1) (MilliSekunden ms2) = MilliSekunden $ (+) ms1 ms2
    (<>) (MilliSekunden ms) (Sekunden s) = MilliSekunden $ (+) ms $ msInS * s
    (<>) (MilliSekunden ms) (Minuten min) = MilliSekunden $ (+) ms $ msInMin * min
    (<>) (MilliSekunden ms) (Stunden h) = MilliSekunden $ (+) ms $ msInH * h
    (<>) (MilliSekunden ms) (Tage d) = MilliSekunden $ (+) ms $ msInD * d
    (<>) (Sekunden s) (NanoSekunden ns) = NanoSekunden $ (+) (nsInS * s) ns
    (<>) (Sekunden s) (MikroSekunden µs) = MikroSekunden $ (+) (µsInS * s) µs
    (<>) (Sekunden s) (MilliSekunden ms) = MilliSekunden $ (+) (msInS * s) ms
    (<>) (Sekunden s1) (Sekunden s2) = Sekunden $ (+) s1 s2
    (<>) (Sekunden s) (Minuten min) = Sekunden $ (+) s $ sInMin * min
    (<>) (Sekunden s) (Stunden h) = Sekunden $ (+) s $ sInH * h
    (<>) (Sekunden s) (Tage d) = Sekunden $ (+) s $ sInD * d
    (<>) (Minuten min) (NanoSekunden ns) = NanoSekunden $ (+) (nsInMin * min) ns
    (<>) (Minuten min) (MikroSekunden µs) = MikroSekunden $ (+) (µsInMin * min) µs
    (<>) (Minuten min) (MilliSekunden ms) = MilliSekunden $ (+) (msInMin * min) ms
    (<>) (Minuten min) (Sekunden s) = Sekunden $ (+) (sInMin * min) s
    (<>) (Minuten min1) (Minuten min2) = Minuten $ (+) min1 min2
    (<>) (Minuten min) (Stunden h) = Minuten $ (+) min $ minInH * h
    (<>) (Minuten min) (Tage d) = Minuten $ (+) min $ minInD * d
    (<>) (Stunden h) (NanoSekunden ns) = NanoSekunden $ (+) (nsInH * h) ns
    (<>) (Stunden h) (MikroSekunden µs) = MikroSekunden $ (+) (µsInH * h) µs
    (<>) (Stunden h) (MilliSekunden ms) = MilliSekunden $ (+) (msInH * h) ms
    (<>) (Stunden h) (Sekunden s) = Sekunden $ (+) (sInH * h) s
    (<>) (Stunden h) (Minuten min) = Minuten $ (+) (minInH * h) min
    (<>) (Stunden h1) (Stunden h2) = Stunden $ (+) h1 h2
    (<>) (Stunden h) (Tage d) = Stunden $ (+) h $ hInD * d
    (<>) (Tage d) (NanoSekunden ns) = NanoSekunden $ (+) (nsInD * d) ns
    (<>) (Tage d) (MikroSekunden µs) = MikroSekunden $ (+) (µsInD * d) µs
    (<>) (Tage d) (MilliSekunden ms) = MilliSekunden $ (+) (msInD * d) ms
    (<>) (Tage d) (Sekunden s) = Sekunden $ (+) (sInD * d) s
    (<>) (Tage d) (Minuten min) = Minuten $ (+) (minInD * d) min
    (<>) (Tage d) (Stunden h) = Stunden $ (+) (hInD * d) h
    (<>) (Tage d1) (Tage d2) = Tage $ (+) d1 d2
