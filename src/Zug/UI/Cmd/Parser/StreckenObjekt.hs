...
class AnfrageWegstreckeZugtyp (z :: Zugtyp) where
    eitherObjektAhängen :: AnfrageWegstrecke z -> Either (Objekt -> (AnfrageWegstrecke z)) (Objekt -> (Wegstrecke z))
...
anfrageWegstreckeAktualisieren :: (AnfrageWegstreckeZugtyp z) =>
    (AnfrageWegstrecke z) ->
    EingabeToken ->
