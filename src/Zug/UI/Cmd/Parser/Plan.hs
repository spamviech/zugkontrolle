...
module Zug.UI.Cmd.Parser.Plan (
    ...
    AnfrageAktionBahngeschwindigkeit(..), AnfrageAktionStreckenabschnitt(..), AnfrageAktionKupplung(..)) where
        ...
        = Left $ case anfrageAktionElement token of
            ...
            AAEWegstrecke
                -> AAKlassifizierung SAOWegstrecke $ Left $
                    \(OWegstrecke wegstrecke) -> _AAWegstrecke $ _AnfrageAktionWegstrecke wegstrecke
            AAEWeiche
            ...
            AAEBahngeschwindigkeit
                -> AAKlassifizierung SAOBahngeschwindigkeit $ Left $
                    \(OBahngeschwindigkeit bahngeschwindigkeit)
                        -> _AABahngeschwindigkeit $ _AnfrageAktionBahngeschwindigkeit bahngeschwindigkeit
            AAEStreckenabschnitt
    ...
    token
        = case anfrageAktionWegstreckeAktualisieren anfrageAktion token of
            (Left (AAWSUnbekannt anfrage eingabe))
                -> Left $ AAUnbekannt (_AAWegstrecke anfrage) eingabe
            (Left qAktionWegstrecke)
                -> Left $ _AAWegstrecke qAktionWegstrecke
            (Right aktionWegstrecke)
                -> Right $ _AWegstrecke aktionWegstrecke
anfrageAktionAktualisieren
    ...
    token
        = case anfrageAktionBahngeschwindigkeitAktualisieren anfrageAktion token of
            (Left (AABGUnbekannt anfrage eingabe))
                -> Left $ AAUnbekannt (_AABahngeschwindigkeit anfrage) eingabe
            (Left qAktionBahngeschwindigkeit)
                -> Left $ _AABahngeschwindigkeit qAktionBahngeschwindigkeit
            (Right aktionBahngeschwindigkeit)
                -> Right $ _ABahngeschwindigkeit aktionBahngeschwindigkeit
anfrageAktionAktualisieren
...
anfrageAktionWegstreckeAktualisieren :: (WegstreckeKlasse (w z), BahngeschwindigkeitKlasse w,
...
anfrageAktionWegstreckeAktualisieren
    ...
    token@EingabeToken {eingabe}
        = wähleBefehl token [
            ...
            (Lexer.Umdrehen         , Left $ AAWSBahngeschwindigkeit $ _AABGUmdrehen wegstrecke),
