...
fn lizenz_dateien() -> BTreeMap<UniCaseOrd<&'static str>, &'static str> {
    ...
    [
        ...
        ("cortex-m-0.7.5", "LICENSE-MIT"),
        ("critical-section-0.2.7", "../LICENSE-APACHE-2.0.txt"),
        ("crossbeam-channel-0.5.5", "LICENSE-MIT"),
        ("crossbeam-deque-0.8.1", "LICENSE-MIT"),
        ("crossbeam-epoch-0.9.9", "LICENSE-MIT"),
        ("crossbeam-utils-0.8.9", "LICENSE-MIT"),
        ...
        ("flexi_logger-0.22.5", "LICENSE-MIT"),
        ...
        ("lyon_geom-0.17.7", "LICENSE-MIT-GITHUB"),
        ...
        ("proc-macro2-1.0.40", "LICENSE-MIT"),
        ("quote-1.0.20", "LICENSE-MIT"),
        ...
        ("wasm-bindgen-0.2.81", "LICENSE-MIT"),
        ("wasm-bindgen-backend-0.2.81", "LICENSE-MIT"),
        ("wasm-bindgen-futures-0.4.31", "LICENSE-MIT"),
        ("wasm-bindgen-macro-0.2.81", "LICENSE-MIT"),
        ("wasm-bindgen-macro-support-0.2.81", "LICENSE-MIT"),
        ("wasm-bindgen-shared-0.2.81", "LICENSE-MIT"),
