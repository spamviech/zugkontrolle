...
import Zug.Anbindung.Anschluss
       (Anschluss(..), AnschlussEither(..), AnschlussKlasse(zuPinGpio)
...
import Zug.Enums (Fahrtrichtung(Vorwärts), GeschwindigkeitVariante(..), Zugtyp(..)
                , ZugtypKlasse(zuZugtypEither), zugtyp)
