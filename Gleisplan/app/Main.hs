...
import Zug.UI.Gtk.Gleis.Widget (gleisAnzeigeConfig, GleisAnzeigeConfig(..))
...
createWindow application = do
    ...
    Gtk.widgetAddTickCallback appWindow $ \_widget frameClock -> do
    ...
    Gtk.widgetAddController appWindow moveController
    -- test legacy events
